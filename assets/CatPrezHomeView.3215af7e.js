import{a1 as K,i as J,B as Z,d as V,x as _,k as G,o as q,h as a,c as i,a as e,z as S,E as x,a8 as ee,C as $,b as o,a5 as X,e as y,F as v,r as P,P as te,t as C,f as L,q as E,m as F,G as H,w as U,p as se,j as ae,_ as le,u as oe,l as ne,O as re}from"./index.cba3b563.js";import{S as ce,_ as ie,s as de}from"./MapClient.vue_vue_type_script_setup_true_lang.4fbcc6d6.js";import{a as ue,B as he}from"./BaseModal.fc5de8eb.js";import{c as pe}from"./helpers.6a12a23c.js";import{E as N,L as B}from"./LoadingMessage.4d3be192.js";function D(u){return K({id:u,state:()=>{const d=J(Z);return{data:[],success:!1,loading:!1,error:null,apiBaseUrl:d}},actions:{async fetch(d){const r=`${this.apiBaseUrl}/sparql`;this.loading=!0,this.success=!1;try{const n=await ue.get(r,{headers:{accept:"application/sparql-results+json"},params:{query:d}});this.data=n.data.results.bindings.map(c=>{let p={};return Object.keys(c).forEach(m=>{p[m]=c[m].value}),p}),this.success=!0,this.error=null}catch(n){this.error=n.message,this.data=[],this.success=!1}finally{this.loading=!1}}}})}const me=`
